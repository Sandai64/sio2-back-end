 ...
 */
final class Version20220105093524 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE blog_page (id INT AUTO_INCREMENT NOT NULL, id_blog_category_id INT NOT NULL, written_by_user_id INT NOT NULL, title LONGTEXT NOT NULL, description LONGTEXT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL, slug VARCHAR(2048) NOT NULL, INDEX IDX_F4DA3AB028FC54CD (id_blog_category_id), INDEX IDX_F4DA3AB062E3BCE6 (written_by_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
